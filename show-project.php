            ...
            <article>
                <div class="content">
                    ...
                    <?php
                        ...
                        echo "<th>Emp-no</th>";
                        echo "<th>Marriage_status</th>";
                        echo "<th>Team_name</th>";
                        echo "<th>Team_members</th>";
                        echo "<th>Project_name</th>";
                        echo "<th>Project_duration</th>";
                    ...
                    ?>
                                ...
                                <td><a href="edit-project.php?id=<?php echo $row['EMP_NO']; ?>" class='edit_btn'>Edit</a></td>
                                <td><a href="delete-project.php?id=<?php echo $row['EMP_NO']; ?>" class='del_btn'>Delete</a></td>
                                </tr>
                    <?php
                            }
                        }

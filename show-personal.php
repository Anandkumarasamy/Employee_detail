            ...
            <article>
                <div class="content">
                    ...
                    ?>
                                ...
                                <td><a href="edit-personal.php?id=<?php echo $row['ID']; ?>" class='edit_btn'>Edit</a></td>
                                <td><a href="delete-personal.php?id=<?php echo $row['ID']; ?>" class='del_btn'>Delete</a></td>
                                </tr>
                    <?php
                            }
                        }

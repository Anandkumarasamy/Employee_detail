            ...
            <article>
                <div class="content">
                    ...
                    <?php
                        ...
                        $sql = "SELECT std_table.EMP_NO, std_table.NAME, work_table.GENDER, work_table.DEPARTMENT, work_table.SYSTEM_NO, project_table.TEAM_NAME, project_table.PROJECT_NAME FROM std_table LEFT JOIN work_table ON std_table.EMP_NO = work_table.EMP_NO LEFT JOIN project_table ON work_table.EMP_NO = project_table.EMP_NO"; 

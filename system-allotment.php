            ...
            <article>
                <div class="content">
                    ...
                    <?php
                        ...
                        $sql = "SELECT std_table.EMP_NO ,std_table.NAME ,work_table.GENDER ,work_table.DEPARTMENT ,work_table.SYSTEM_NO from std_table inner JOIN work_table on std_table.EMP_NO=work_table.EMP_NO"; 
